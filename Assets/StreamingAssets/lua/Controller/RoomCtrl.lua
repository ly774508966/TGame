...
function RoomCtrl.OnCreate(obj,new)
	...
	UnityMonoUtil.AddTriggerEvent(RoomPanel.t,function (oth) logWarn("碰撞了！！！")end,nil,nil);
	UnityMonoUtil.AddTriggerEvent(RoomPanel.d,function (oth) logWarn("碰撞了！！！")end,nil,nil);
	UnityMonoUtil.AddTriggerEvent(RoomPanel.l,function (oth) logWarn("碰撞了！！！")end,nil,nil);
	UnityMonoUtil.AddTriggerEvent(RoomPanel.r,function (oth) logWarn("碰撞了！！！")end,nil,nil);
