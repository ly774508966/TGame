...
function FancyCtrl.OnCreate(obj,new)
	...
	UnityMonoUtil.GetComponent(FancyPanel.save,"CaptureBehaviourScript").ca = FancyPanel.camera;
...
function FancyCtrl.GJOnClick(go)
	...
	ngo.transform.localPosition = Vector3.New(ngo.transform.localPosition.x,ngo.transform.localPosition.y,0);
