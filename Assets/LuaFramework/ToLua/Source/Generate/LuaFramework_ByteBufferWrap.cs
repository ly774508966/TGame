...
public class LuaFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("BytesToInt", BytesToInt);
		L.RegFunction("IntToBytes", IntToBytes);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int BytesToInt(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			...
			int o = LuaFramework.ByteBuffer.BytesToInt(arg0, arg1);
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int IntToBytes(IntPtr L)
	{
		try
		{
			...
			byte[] o = LuaFramework.ByteBuffer.IntToBytes(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
