...
public class MoveBehaviourScript : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler,
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (isRect)
        {
            ...
            if (imgRect.anchoredPosition.x < lt.anchoredPosition.x || imgRect.anchoredPosition.y > lt.anchoredPosition.y ||
                imgRect.anchoredPosition.x > rd.anchoredPosition.x || imgRect.anchoredPosition.y < rd.anchoredPosition.y)
                Destroy(gameObject);
        }
    }
